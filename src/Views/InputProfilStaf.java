 ...
 * @author programmer
 */
public class InputProfilStaf extends javax.swing.JFrame {
    ...
    private void radioINAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioINAActionPerformed
        if (wargaNegara.getSelection().isSelected()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputProfilStaf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
